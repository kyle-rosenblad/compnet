...
RcppExport SEXP _rcpp_module_boot_stan_fit4ame_fnchypg_withoutolre_mod();
RcppExport SEXP _rcpp_module_boot_stan_fit4base_fnchypg_mod();
RcppExport SEXP _rcpp_module_boot_stan_fit4srm_binomial_mod();
RcppExport SEXP _rcpp_module_boot_stan_fit4srm_fnchypg_mod();
RcppExport SEXP _rcpp_module_boot_stan_fit4srm_fnchypg_withoutolre_mod();
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rcpp_module_boot_stan_fit4ame_fnchypg_withoutolre_mod", (DL_FUNC) &_rcpp_module_boot_stan_fit4ame_fnchypg_withoutolre_mod, 0},
    {"_rcpp_module_boot_stan_fit4base_fnchypg_mod", (DL_FUNC) &_rcpp_module_boot_stan_fit4base_fnchypg_mod, 0},
    ...
    {"_rcpp_module_boot_stan_fit4srm_fnchypg_withoutolre_mod", (DL_FUNC) &_rcpp_module_boot_stan_fit4srm_fnchypg_withoutolre_mod, 0},
    {NULL, NULL, 0}
};
