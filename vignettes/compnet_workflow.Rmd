...
This all looks fine. To keep this vignette brief, we'll suppress the plots that accompany the DHARMa tests from now on, but I recommend always having a look for your own projects.
...
testQuantiles(nd_dom_0_mod_dharmam, plot=FALSE)
