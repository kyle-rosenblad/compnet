...
nd_1_mod_dharma <- createDHARMa(simulatedResponse = nd_1_mod_ppred,
                                observedResponse = nd_1_mod$d$both/nd_1_mod$d$either,
...
Good thing we checked! We've got overdispersion, uneven quantiles, and strong deviations from the expected shape of our model's binomial distribution. Often when we see these kinds of problems, we might be tempted to use a different distribution, like beta-binomial or zero-inflated binomial. 'compnet' supports those, but we won't use them here.
...
nd_dom_1_mod_dharma <- createDHARMa(simulatedResponse = nd_dom_1_mod_ppred,
                                observedResponse = nd_dom_1_mod$d$both/nd_dom_1_mod$d$either,
                                fittedPredictedResponse = fpr,
                                integerResponse = TRUE)
