...
Get data for a plot of the interactive effect of two species' values of
the same trait.

## Usage

``` r
plot_interaction_getdata(
  mod,
  xvar,
  orig.scale = T,
...
A data frame containing data needed to plot mean curves and credible
bands as done in the plot_interaction function.
